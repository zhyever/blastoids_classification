...
from estimator.utils import RunnerInfo, setup_env, log_env, fix_random_seed, convert_zoed_lora
...
def main():
    ...
    # enable automatic-mixed-precision training (future)
    ...
    if runner_info.distributed:
        ...
        if cfg.get('lora', False):
            convert_zoed_lora(model, cfg.get('lora_linear_rank', 8), cfg)
